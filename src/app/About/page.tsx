        ...
        <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-10 items-center">
          <motion.div
            ...
            <p className="text-gray-600 leading-relaxed">
              Founded on a passion for fine craftsmanship and innovation, we
              have spent decades perfecting the art of creating luxury
              wristwatches. Each piece is a testament to precision engineering
      ...
      <section className="py-16 bg-gray-100 px-6 md:px-12 lg:px-24">
        <div className="max-w-5xl mx-auto text-center mb-12">
          ...
          <p className="text-gray-600 max-w-3xl mx-auto">
            ...
            blending traditional techniques with modern innovations to ensure
            that every timepiece tells a story of elegance and excellence.
          </p>
        </div>
        <div className="grid md:grid-cols-3 gap-8">
          {[
            "/images/card4.avif",
            "/images/eyeglass.avif",
